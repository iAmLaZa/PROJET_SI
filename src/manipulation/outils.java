...
public class outils {
    ...
    public static boolean showconfirmationmessage(String titre, String message){
        Alert a=new Alert(Alert.AlertType.CONFIRMATION);
        a.setTitle(titre);
        a.setContentText(message);
        Optional<ButtonType> resulat= a.showAndWait();
        if(resulat.get()==ButtonType.OK)return true;
            else return false;
    }
    ...
    private  void loadpage(ActionEvent event, String title, String url) throws IOException{
        ...
        stage.getIcons().add(new Image(this.getClass().getResourceAsStream("/image/images.jpg")));
